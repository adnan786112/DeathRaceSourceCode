...
public class CarController : MonoBehaviour
{
    ...
    public static bool PerframeNameAssignbool = false;
    ...
    public bool IsAICarEffective = false;//this bool checks is this car is ai car and is effective than the carusercontrol.instance.isaicar because this script will be active on each car regardless of player or client
    ...
    private void Update()
    {
        // Only the local network player should write to SaveScript statics
       
        bool isLocalNetworkPlayer = netObj.IsOwner && !IsAICarEffective;
